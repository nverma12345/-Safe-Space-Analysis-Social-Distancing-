...
def fireInterVal(hour):
	firebase1 = firebase.FirebaseApplication('https://socialspace-d1591.firebaseio.com/', None)
	now = datetime.datetime.now()
	print("fireInterval Called")
	...
	#result = firebase1.post('/historicData',data)
	#print(result)
...
def fireUpdate(count):
	global previousCount
	previousCount = count
	result = firebase1.put('/stores/-MD4X81n_lXprCpnkhPM/','counter',count)
	print(result)
